...
//         {/* Top navigation */}
//         <nav className="bg-navy-800 shadow-sm py-4 px-6">
...
//                   {product.isNew && (
//                     <span className="bg-navy-700 text-white text-xs px-3 py-1 rounded-full font-medium">جديد</span>
//                   )}
//                   {product.discount && (
...
//               {/* Title and rating */}
//               <div>
//                 <h1 className="text-2xl md:text-3xl font-bold text-navy-900">{product.name}</h1>
...
//               {/* Quantity */}
//               <div>
//                 <h3 className="text-lg font-medium text-navy-800 mb-2">الكمية:</h3>
...
//               {/* Features */}
//               <div>
//                 <h3 className="text-lg font-medium text-navy-800 mb-2">المميزات:</h3>
...
//               <h2 className="text-xl font-bold text-navy-800 mb-4">وصف المنتج</h2>
//               <p className="text-gray-700 leading-relaxed">{product.description}</p>
//             </div>
            
//             {/* Specifications */}
//             <div className="bg-white rounded-2xl shadow-md overflow-hidden mb-8">
//               <h2 className="text-xl font-bold text-navy-800 p-6 pb-4">المواصفات الفنية</h2>
...
//                   >
//                     <span className="w-1/3 font-medium text-navy-700">{spec.name}</span>
...
//             {/* Related products */}
//             <div className="mb-8">
//               <h2 className="text-xl font-bold text-navy-800 mb-6">منتجات ذات صلة</h2>
...
//                       </div>
//                       <div className="p-4">
//                         <h3 className="font-medium text-navy-800 mb-1 line-clamp-2">{related.name}</h3>
...
const ProductDetailPage = () => {
  ...
  useEffect(() => {
    ...
    const fetchProduct = async () => {
      try {
        const res = await fetch(`https://mahmoudmohammed.site/api/public/products/${id}`);
